 ...
 */
	...
	// mainly initilizes page table for low memory, permanent mapping and 
	// fixed address, and initialize zones. At this point, buddy allocator is still 
	// not usable since all pages in the zones are marked reserved.
	//
	// Here mem_init mainly uses bootmem bitmap to add free page frames 
